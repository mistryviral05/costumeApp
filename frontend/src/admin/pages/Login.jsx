...
const Login = () => {
  ...
  <div className="font-[sans-serif]">
      <div className="grid lg:grid-cols-2 gap-4 max-lg:gap-12 bg-gradient-to-r from-blue-500 to-blue-700 sm:px-8 px-4 py-12 h-[320px]">
        ...
        <div className="bg-white cursor-pointer text-black flex items-center justify-center rounded-full p-2 ">
                        <svg
                    ...
                    <span className="cursor-pointer text-lg md:text-xl font-semibold text-white">
                        Costume Management
                    </span>
                    </div>
        ...
        <div className="bg-white rounded-xl sm:px-6 px-4 py-8 max-w-md w-full h-max shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] max-lg:mx-auto">
          <form>
            ...
            <div className="mt-8">
              <button type="button" className="w-full shadow-xl py-2.5 px-4 text-sm font-semibold rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none">
                Log in
              </button>
            </div>
            <p className="text-sm mt-6 text-center text-gray-800">Don't have an account <NavLink to={'/admin/signup'} className="text-blue-600 font-semibold hover:underline ml-1 whitespace-nowrap">Register here</NavLink></p>
          </form>
        </div>
      </div>
    </div>
